  ...
  return (
    <div
      className={`flex items-center justify-between border ${
        isSelected ? "border-charcoal-80" : "border-charcoal-40"
      ...
      <div className="flex flex-1 items-center space-x-4">
        ...
        <div className="flex justify-between w-full items-center pr-2">
          <div className="flex flex-col">
            ...
            <BodyText
              color="black"
              styles="font-light text-charcoal-60"
              size={2}
            >
              {hotel.region}
            </BodyText>
          ...
          {isSelected && (
            <div
              className={` ml-auto mr-0 items-center justify-center rounded-full bg-charcoal-80 text-white `}
            >
              <svg
