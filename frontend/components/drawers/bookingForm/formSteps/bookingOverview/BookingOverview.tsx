  ...
  return (
    <div className={`grid lg:grid-cols-7 relative`}>
      ...
      >
        ...
        {/* hotel information */}
        <div
          className={`border border-sea-20 rounded-md flex flex-row gap-4 p-4`}
        >
          <span
            className={`w-[36px] h-[36px] flex rounded-full bg-sea-20 items-center justify-center`}
          >
            <svg
        ...
        <div
          className={`border border-sea-20 rounded-md flex flex-row gap-4 p-4 relative`}
        >
          <span
            className={`w-[36px] h-[36px] flex rounded-full bg-sea-20 items-center justify-center`}
          >
          ...
          <button
            onClick={onPrev}
            className={`absolute top-2 right-4 underline text-sea-80`}
          >
            Edit
          </button>
        </div>
        ...
        >
          ...
          <div>
            ...
            <p>{`${bookingData.startDate?.toLocaleString("default", {
              day: "numeric",
              month: "short",
              year: "numeric",
            })} - ${bookingData.endDate?.toLocaleString("default", {
              day: "numeric",
              month: "short",
              year: "numeric",
            })}`}</p>
        ...
        <div>
          ...
          <ul className={`text-sm flex gap-2 flex-col text-earth-100`}>
            ...
            <li>
              - You will not get charged unless otherwise stated. You will pay
        ...
        <div className={`flex flex-col gap-2`}>
          ...
          <div
            ...
            className={`rounded-md border border-sea-20 p-4 flex gap-4 flex-row group hover:border-sea-60 align-center h-[64px] bg-sea-20 cursor-not-allowed relative`}
          >
            {/* pay with card  */}
            ...
            <span
              className={`absolute w-8 h-8 rounded-full flex right-4 border border-sea-20 group-hover:border-sea-60`}
            ></span>
          </div>
          <div
            onClick={() => alert("Feature not available yet")}
            ...
            <div className={`flex flex-row gap-2 w-fit`}>
              <span>
                ...
                >
                  ...
                  <path
                    fill="#4A61DA"
                    d="M23.06 14.305c-1.498.616-2.748 1.466-3.567 2.49l-2.11-5.06a8.913 8.913 0 0 1 3.566-2.488c1.497-.617 3.01-.915 4.295-.741l2.111 5.058a8.97 8.97 0 0 0-4.296.741Z"
                  ></path>
                  <path
                    fill="#5A78FF"
                    d="M23.747 15.846c-1.621 0-3.105.311-4.255.945v-5.114a8.97 8.97 0 0 1 4.255-.945c1.62 0 3.133.298 4.253.946v5.115a8.966 8.966 0 0 0-4.253-.947Z"
                  ></path>
                  <rect
                    width="39"
                    height="27"
          ...
          <div
            className={`rounded-md border border-sea-20 p-4 flex gap-4 flex-row group hover:border-charcoal-100 align-center h-[64px] cursor-pointer relative mb-4 ${
              bookingData.paymentMethod === "checkin"
                ? `border-charcoal-100`
                : ""
            }`}
          ...
          >
            ...
            <span
              className={`absolute border-box w-8 h-8 rounded-full flex items-center justify-center right-4 border ${
                bookingData.paymentMethod === "checkin"
                  ? `border-charcoal-100 bg-charcoal-100 group-hover:border-charcoal-100`
                  : "border-sea-20 group-hover:border-charcoal-100"
              }`}
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
      ...
      <section
        className={`col-span-7 flex flex-row justify-end p-6 border-t border-sea-20`}
      >
        <Button
          onClick={onNext}
          color={"sea"}
          isActive={bookingData.paymentMethod !== "" ? true : false}
        >
          Next
        </Button>
      </section>
