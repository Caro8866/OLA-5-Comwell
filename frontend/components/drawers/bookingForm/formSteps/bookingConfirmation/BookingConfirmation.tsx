      ...
      <section className={`col-span-4 p-6 h-full min-h-[calc(100vh-40px)] flex gap-4 flex-col`}>
          ...
          <svg width="30" height="31" viewBox="0 0 30 31" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <defs>
              <clipPath id="clip0_2_20691">
                <rect width="30" height="30" fill="white" transform="translate(0 0.882812)" />
              </clipPath>
            </defs>
          </svg>
        ...
        {bookingReferenceNumber && (
          <p className={`mt-2 text-earth-80 text-body-small font-medium`}>
            Your booking reference number is: <span className="text-charcoal-100 font-semibold font-sans">{bookingReferenceNumber}</span>
          </p>
        )}
        ...
        <div className="flex gap-2 font-semibold">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" className="h-[16px] w-[16px]">
            <path fill="#161616" d="M12.5 3a3.75 3.75 0 1 1 0 7.5 3.75 3.75 0 0 1 0-7.5Zm0-1.5a5.25 5.25 0 1 0 0 10.5 5.25 5.25 0 0 0 0-10.5ZM20 22.5h-1.5v-3.75A3.75 3.75 0 0 0 14.75 15h-4.5a3.75 3.75 0 0 0-3.75 3.75v3.75H5v-3.75a5.25 5.25 0 0 1 5.25-5.25h4.5A5.25 5.25 0 0 1 20 18.75v3.75Z"></path>
