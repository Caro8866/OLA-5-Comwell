  ...
  return (
    <section className={`md:flex transition`}>
      <span
        ...
        className={`flex absolute z-50 top-4 right-4 md:hidden p-2 cursor-pointer bg-charcoal-20 rounded-full`}
      >
        {isMenuVisible ? (
          <svg
            width="24"
      ...
      >
        <span
          className={`hidden md:flex absolute top-8 cursor-pointer transition-all ${
            !isMenuExpanded ? "right-5" : "right-8"
          }`}
        ...
        >
          ...
          >
            <path
              d="M18.75 7.5H12.75C12.3523 7.50046 11.9711 7.65864 11.6898 7.93984C11.4086 8.22105 11.2505 8.60232 11.25 9V13.5H3V4H1.5V21H3V15H21V21H22.5V11.25C22.4988 10.2558 22.1034 9.30265 21.4004 8.59964C20.6973 7.89664 19.7442 7.50117 18.75 7.5ZM21 13.5H12.75V9H18.75C19.3465 9.00066 19.9185 9.23792 20.3403 9.65973C20.7621 10.0815 20.9993 10.6535 21 11.25V13.5Z"
              fill="black"
            />
            <path
