...
function BookingList(props: Props) {
  return (
    <section className={`flex flex-col gap-2 py-4 max-h-96 overflow-y-scroll`}>
      ...
      >
        <p className={`col-span-6 lg:col-span-5 xl:col-span-3`}>Details</p>
        <p
          className={`col-span-2 xl:col-span-3 hidden lg:flex flex-row justify-center`}
        >
          Hotel name
        </p>
        <p className={`col-span-5 lg:col-span-2 xl:col-span-3`}>Date</p>
        <p className={`col-span-1 hidden lg:flex justify-center`}>Amount</p>
      ...
      {props.bookings &&
        props.bookings.map((booking) => {
          const hotelName = props.hotels?.find((hotel) => {
            if (hotel._id === booking.hotelId) {
              return hotel.name;
            } else {
              return false;
            }
          ...
          return (
            ...
            >
              <div
                className={`col-span-6 lg:col-span-5 xl:col-span-3 flex flex-col gap-1 justify-center`}
              >
                <p
              ...
              <div
                className={`col-span-1 lg:col-span-2 xl:col-span-3 hidden lg:flex items-center justify-center`}
              >
                <p className={`font-medium text-trumpet-desktop text-center`}>
                  {hotelName?.name}
                </p>
              </div>
              <div
