      ...
      <div className="bg-white p-6 max-w-[450px] rounded-lg shadow-md z-[100] relative">
        ...
        {bookingType === "accomodation" && (
          <form className="flex flex-col space-y-2 " onSubmit={(e) => e.preventDefault()}>
            ...
            <Button color="sea" isFullWidth={true} isActive={bookingData.hotel && bookingData.startDate && bookingData.endDate ? true : false} onClick={handleSearch} styles="flex items-center justify-center gap-x-1 font-light">
              Search
