...
function index() {
  ...
  const handleSearch = () => {
    ...
    if (selectedHotel != null && selectedPeopleCount != null && selectedStartDate != null && selectedEndDate != null) {
      ...
      console.log("After updating booking data", bookingData);
        ...
        <BookingContextProvider>
          ...
          <main className={`max-w-screen overflow-hidden`}>
            <section id="hero" className={`w-full h-[calc(100vh-118px)] relative pt-[86px] z-20 `}>
              <div className={`bg-gradient-to-t from-transparent via-transparent to-[rgba(0,0,0,0.75)] h-64 w-full absolute z-10 top-0 left-0 pointer-events-none`}></div>
              <div className={`w-full h-full z-20 relative max-w-2xl 2xl:max-w-[1600px] mx-auto flex justify-center items-center lg:justify-start lg:items-end pb-4 lg:pb-12`}>
                <div>
                  <SearchWidget
