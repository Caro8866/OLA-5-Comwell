        ...
        <main className={`max-w-screen overflow-hidden`}>
          ...
          <section id="" className={`max-w-screen-2xl 2xl:max-w-[1600px] grid sm:grid-cols-2 md:grid-cols-3 gap-2 md:gap-4 py-20 px-8 mx-auto`}>
            ...
            {!areOffersLoading &&
              ...
              offers
                .slice(-3)
                .map((offer, index) => <InfoCard key={offer._id} src={offer.image} title={offer.name} description={offer.description} label={offer.tag} href={`/${offer.href}`} styles={`${index == 0 ? `col-span-2` : `col-span-1`} md:col-span-1`} />)}
          </section>
